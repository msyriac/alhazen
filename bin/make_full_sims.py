"""
Given a patch definition, say 400sqdeg in the south
Make a full-sky sim and lens it
Cut out the required patch and save it
Rotate the patch to the equator and save it
Cut out an equivalent patch at the equator and save it

Do this for the N1-enabled sim suite (i.e. common kappa etc.)
...
from orphics.analysis.pipeline import SpectrumVerification
...
import argparse
parser = argparse.ArgumentParser(description='Make full-sky sims meant for Clkk analysis')
