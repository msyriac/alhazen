...
parser.add_argument("KappaGrid", type=str,help='Name of section for kappa M,z grid.')
parser.add_argument("Out", type=str,help='Output Directory Name (not path, that\'s specified in ini')
parser.add_argument("Exp", type=str,help='Experiment name (for beam only!)')
parser.add_argument("Nsims", type=int,help='Total number of sims')
parser.add_argument("-M", "--mass_index",     type=int,  default=0)
parser.add_argument("-z", "--z_index",     type=int,  default=0)
...
parser.add_argument("-p", "--do_pol", action='store_true',help='Do polarization')
parser.add_argument("-d", "--dimensionless", action='store_true',help='Dimensionless sims')
...
pout_dir = os.environ['WWW']+"plots/pix_cov_"+args.Out+"_"
