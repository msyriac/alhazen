...
for k,i in enumerate(myIs):
    ...
    filt_noiseT = fot.copy()*0.+gGenT.power/TCMB**2.
    filt_noiseE = fot.copy()*0.+gGenP1.power/TCMB**2.
    filt_noiseB = fot.copy()*0.+gGenP2.power/TCMB**2.
    ...
    reconLm.writeFits(simRoot+"matRecon_"+ str(i).zfill(5)+".fits",overWrite=True)
